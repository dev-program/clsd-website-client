...
export default function EventPost({id, firstName,middleName, lastName, suffix, designation, fileName }) {
...
<>
          ...
          <Card className="mt-4 mb-4" bg="light" align='center' >
            <Style>
              <Card.Body>
              <Card.Img    class="rounded-circle" variant="top"   width="150" height="150"   src={`http://localhost:5001/api/researcher-content/${fileName}`}  />
              <br></br>
                <br></br>
