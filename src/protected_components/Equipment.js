...
import UserService from "../services/equipment.service";
            ...
            <form>
              ...
              {currentTutorial.fileName && (
                <div className="form-group mb-4">
                  ...
                  {!currentTutorial.imagePreviewUrl && (
                    <img
                      src={`http://localhost:5001/api/equipment-content/${currentTutorial.fileName}`}
                      alt="Equipment Image"
                      style={{ height: "250px" }}
                    />
                  )}
