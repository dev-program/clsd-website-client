        ...
        <div className="container mb-4 mt-4 bg-color-white" >
          ...
          {/*
            <Video  
               ...
               poster="http://localhost:5001/api/collection-content/CLSD-building.jpg"
                 onCanPlayThrough={() => {
                     // Do stuff
                 }}>
                 <source src="http://localhost:5001/api/avp-content/NICER-AVP.mp4" type="video/webm" />
...
/>
            ...
            <div className="col-12 col-md-6 col-xl-5 order-md-1 section">
              <p sx={{ fontStyle: "Bebas Neue" }}
                className="mt-5 font-weight-medium text-xs text-uppercase text-primary "
